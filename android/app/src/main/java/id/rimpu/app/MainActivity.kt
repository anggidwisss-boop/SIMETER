...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configureWebView()
        webView.loadUrl("https://anggidwisss-boop.github.io/SIMETER/?v=20260816-8")
    ...
    private fun configureWebView() {
        ...
        webView.settings.apply {
            ...
            userAgentString = "$userAgentString RIMPU-Android/1.0.4-WeatherFix"
        }
        webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView, url: String) {
                super.onPageFinished(view, url)
                view.evaluateJavascript("(function(){var s=document.createElement('script');s.src='https://anggidwisss-boop.github.io/SIMETER/task-weather-v2.js?v=20260816-2';document.body.appendChild(s);})();", null)
            }
