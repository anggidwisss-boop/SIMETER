...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configureWebView()
        webView.loadUrl("https://anggidwisss-boop.github.io/SIMETER/?v=20260818-rimpu-android-final-1.3.0")
    ...
    private fun configureWebView() {
        ...
        webView.settings.apply {
            ...
            userAgentString = "$userAgentString RIMPU-Android/1.3.0-PLN-UP3-BIMA"
        }
        webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView, url: String) {
                super.onPageFinished(view, url)
                view.evaluateJavascript("(function(){var s=document.createElement('script');s.src='https://anggidwisss-boop.github.io/SIMETER/rimpu-android-final.js?v=20260818-rimpu-android-final-1.3.0';document.body.appendChild(s);})();", null)
            }
